...
//		           	 2013/04/22		LHK			0.20  add dram size scan
//			 					 2013/04/24		LHK			0.30  add master priority 
//								 2013/04/26		LHK			0.40  add dram PLL	EMC function and change PLL ddr1 setting
//								 2013/05/07		LHK			0.50  add DLL-OFF for auto gate mode
//                                            add more delay at setting MC_CLKEN for two rank
//                 2013/05/08		LHK			0.60  fix master priority ,change tccd from 4 to 2
//                 2013/05/10		LHK			0.70  fix dual rank odt setting 
//                 2013/05/15		LHK			0.80  add watch dog for reboot test according to A23
//                 2013/05/20		LHK			0.90  delete dll off function for Mira ddr
//                 2013/05/21		LHK			1.00  add watch dog for onther branch
//                 2013/05/26		LHK			1.10  fix rank to rank timing for miracast 
//                                            add read/write priority             
//                 2013/05/26		LHK			1.20  change pll-ddr0 setting     
//                 2013/06/12		LHK			1.30  change pll-ddr1/pll-ddr0 setting for black screen and sscg
//                                            fix dram_para1 
//                 2013/07/4		LHK			1.40  change pll-ddr1 setting for stability
...
signed int init_DRAM(int type, __dram_para_t *para)
{
  ...
  unsigned int dram_size = 0;
	UART_printf2("DRAM DRIVE INFO: V1.4\n");
